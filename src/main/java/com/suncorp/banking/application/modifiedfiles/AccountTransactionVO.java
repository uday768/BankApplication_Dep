...
public class AccountTransactionVO {
	...
	public AccountTransactionVO() {
		super();
		// TODO Auto-generated constructor stub
	}

	public AccountTransactionVO(String typeOfTrans, String referenceId, String referenceMsg,
			AccountVo account) {
		super();
	...
	public AccountTransactionVO(String typeOfTrans, double fund, String referenceId, String referenceMsg,
			AccountVo account) {
		super();
		this.typeOfTrans = typeOfTrans;
		this.fund = fund;
